...
<head>
    <title>@yield('title', 'Dashboard Admin de Obra')</title>
    <meta charset="utf-8">
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header" style="background:#fff; padding:12px;">
                <a href="{{ route('admin.empresa') }}" class="b-brand brand-akl">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-caption">
                        ...
                        <span class="pc-mtext" style="font-weight:800; font-size:15px; color:#0f172a;">
                            Dashboard Admin de Obra
                        </span>
                    </li>

                    <li class="pc-item">
                        <a href="{{ route('admin.empresa') }}" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('admin.nuevoPedido') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-truck"></i></span>
                            <span class="pc-mtext">Nuevo Pedido</span>
                        </a>
                    </li>

                    <li class="pc-item">
                        <a href="{{ route('admin.misPedidos') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-bolt"></i></span>
                            <span class="pc-mtext">Mis Pedidos</span>
                        </a>
                    </li>

                    <li class="pc-item">
                        <a href="{{ route('admin.historial') }}" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('admin.guias') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-file-text"></i></span>
