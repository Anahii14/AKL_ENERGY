...
<head>
    <title>@yield('title', 'Dashboard Gerente')</title>
    <meta charset="utf-8">
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header" style="background:#fff; padding:12px;">
                <a href="{{ route('gerente.dashboard_gerencial') }}" class="b-brand brand-akl">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('gerente.dashboard_gerencial') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-building"></i></span>
                            <span class="pc-mtext">Dashboard Gerencial</span>
                        </a>
                    </li>
