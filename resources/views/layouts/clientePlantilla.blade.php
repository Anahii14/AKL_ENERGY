...
<head>
    <title>@yield('title', 'Dashboard Cliente')</title>
    <meta charset="utf-8">
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header" style="background:#fff; padding:12px;">
                <a href="{{ route('cliente.empresa') }}" class="b-brand brand-akl">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('cliente.empresa') }}" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('cliente.gruas') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-truck"></i></span>
                            <span class="pc-mtext">Grúas</span>
                        </a>
                    </li>

                    <li class="pc-item">
                        <a href="{{ route('cliente.electrico') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-bolt"></i></span>
                            <span class="pc-mtext">Eléctrico</span>
                        </a>
                    </li>

                    <li class="pc-item">
                        <a href="{{ route('cliente.estado') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-file-text"></i></span>
                            <span class="pc-mtext">Estado</span>
                        </a>
                    </li>
